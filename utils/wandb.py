...
def setup_wandb(
    ...
    **additional_init_kwargs,
    ...
    # check if dir exists.
    if os.path.exists("/home/kvfrans/wandb/tmp"):
        wandb_output_dir = "/home/kvfrans/wandb/tmp"
    elif os.path.exists("/global/scratch/users/kvfrans/wandb"):
        wandb_output_dir = tempfile.mkdtemp(dir="/global/scratch/users/kvfrans/wandb")
    else:
